...
export interface MonthlyMetric {
  month: string; // e.g. "2025-09", "2025-10"
...
export interface ScenarioInput {
  revenueGrowthPct: number; // e.g. +10, -20
  expenseGrowthPct: number; // e.g. +15, -10
  marketingSpendDelta: number; // e.g. +20000, -15000
  newHiresCount: number; // e.g. 3
  avgHireSalary: number; // e.g. 120000/yr -> 10000/mo
}
